...
export const STORAGE_MAINTENANCE_COOLDOWN_MS = 60 * 1000;
...
export const FILTERED_SEARCH_SCAN_BATCH_SIZE = 250;

export const FILTERED_SEARCH_SCAN_MAX_ENTRIES = 5_000;

export const FILTERED_SEARCH_SCAN_TIME_BUDGET_MS = 4_000;
